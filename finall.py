...
def encode_video(input_path, output_path):
    try:
        ffmpeg_path = r'C:\Users\DINESH\Downloads\tkinter\ffmpeg-v1\bin\ffmpeg.exe'
...
def trim_video(file_path, start_time, end_time):
    ...
    print("trimed vedio --------------> "+trimmed_file)
...
class VideoPlayerApp:
    ...
    def setup_gui(self):
        ...
        self.upload_excel_button = customtkinter.CTkButton(self.left_first_container, text="Upload Excel  ", width=9, command=self.upload_file, fg_color="green", hover_color="green")
        self.upload_excel_button.grid(row=1, column=1, sticky="ew",padx=10)

        # Setup Excel input widgets
        # self.column_label = tk.Label(self.left_container)
        # self.column_label.grid(row=3, column=0, pady=5)
        ...
        # self.date_time_label = tk.Label(self.left_frame, text="DATE AND TIME values:")
        # self.date_time_label.grid(row=6, column=0, pady=5)
        self.date_time_text = tk.Text(self.left_container, height=10, width=50)
        # self.date_time_text.grid(row=7, column=0, columnspan=2, pady=5)
        ...
        self.skip_forward_button.grid(row=0, column=1, pady=10)
        ...
        self.skip_backward_button.grid(row=0, column=3, pady=10)
        ...
        # self.end_label =tk.Label(self.left_third_container, text="End Time (HH:MM:SS):",bg="grey")
    ...
    def trim_and_download(self):
        ...
        trimmed_file = trim_video(self.encoded_file_path, start_time, end_time)
        if trimmed_file:
